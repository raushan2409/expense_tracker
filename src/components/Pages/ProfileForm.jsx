...
export default function ProfileForm() {
  ...
  return (
    <>
      <div className="max-w-[auto] max-h-[auto] flex justify-between bg-slate-300 p-2  shadow-lg shadow-indigo-500/40 ">
        <p className="text-xl font-serif p-2">
          {" "}
          Winners never quite, Quitters never win.
        </p>

        <div className="bg-[#e7dada] max-w-[40%] w-[350px] max-h-[auto] h-12 italic rounded-lg p-1 text-[13px] font-serif">
      ...
      <form action="submit" onSubmit={submitHandler}>
        <div className="h-auto p-4 bg-slate-200 m-11 ml-11 rounded-xl ">
